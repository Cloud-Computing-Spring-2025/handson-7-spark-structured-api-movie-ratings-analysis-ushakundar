...
def analyze_movie_watching_trends(df):
    ...
    """
    trends = df.groupBy("WatchedYear").agg(count("MovieID").alias("MoviesWatched"))
    return trends.orderBy("WatchedYear")
...
def main():
    ...
    output_file = "/workspaces/handson-7-spark-structured-api-movie-ratings-analysis-ushakundar/outputs/movie_watching_trends.csv"
